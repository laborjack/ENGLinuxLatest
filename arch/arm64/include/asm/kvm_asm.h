...
#define PMCCNTR_EL0	89	/* Cycle Counter Register */
#define PMOVSSET_EL0	90	/* Performance Monitors Overflow Flag Status Set Register */
#define PMCNTENSET_EL0	91	/* Performance Monitors Count Enable Set Register */
#define PMINTENSET_EL1	92	/* Performance Monitors Interrupt Enable Set Register */
#define PMUSERENR_EL0	93	/* Performance Monitors User Enable Register */
#define PMSELR_EL0	94	/* Performance Monitors Event Counter Selection Register */
#define PMCCFILTR_EL0	95	/* Cycle Count Filter Register */
#define PMEVCNTR0_EL0	96	/* Performance Monitors Event Counter Register (0-30) */
#define PMEVTYPER0_EL0	97	/* Performance Monitors Event Type Register (0-30) */
#define PMEVCNTR30_EL0	156
#define PMEVTYPER30_EL0	157
